...
def main():
    ...
    banner = """\u001b[36m
       ...
       🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴 ___ ___  (_)__/ /__ ____ 🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴
               GO SPIDEY!       (_-</ _ \/ / _  / -_) __/🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴
      🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴/___/ .__/_/\_,_/\__/_/   🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴
                                  /_/     \u001B[33m               
                            
                           \u001b[32m - coded with <3 by Alex Bieber\u001B[5m 
    """
    print(banner)

    parser = argparse.ArgumentParser(
        description='BrahmAstra a parameter discovery suite')
    parser.add_argument(
    ...
    parser.add_argument('-p', '--placeholder',
                        help='The string to add as a placeholder after the parameter name.', default="FUZZ")
    parser.add_argument(
        '-q', '--quiet', help='Do not print the results to the screen', action='store_true')
    parser.add_argument(
        '-r', '--retries', help='Specify number of retries for 4xx and 5xx errors', default=3)
    ...
    print(
        f"\u001b[32m[+] Total unique urls found : {len(final_uris)}\u001b[31m")
    if args.output:
        if "/" in args.output:
            print(
